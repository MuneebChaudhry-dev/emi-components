...
const tags = ref(['Alabama', 'Alaska', 'Arizona', 'Arkansas', 'California']);
  ...
  <div class="border border-gray-400 px-28">
    ...
    <div class="w-full">
      <FormKit
        type="group"
        :actions="false"
        name="parentalFormData"
        v-model="parentalFormData"
      >
        <FormKit
          type="select"
        ...
        <div>
          ...
          <div v-if="parentalFormData.is_high_value_transactions">
            <FormKit
              type="text"
        ...
        <div>
          <div class="flex w-full items-center gap-4 mb-4">
            ...
            >
              ...
              >
                <template #text
                  >Ability to restrict transactions at specific merchants or
                  types of merchants (like online stores, gaming sites,
                  etc.).</template
                >
              </BaseTooltip>
            </div>
